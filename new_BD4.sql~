...
create table operationMode(id integer not null, idSystem int not null, falseRejection int, falseAcceptance int, trueRejection int, trueAcceptance int, foreign key (idSystem) references system(id), primary key (id, idSystem));
...
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance) values (1,3,0,0,0,0);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance) values (2,3,0,0,0,0);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance) values (3,3,0,0,0,0);
