...
create table template(id integer not null, idUser int not null, idSystem int not null, registerDate text, quality int, type int, minutiae clob, foreign key (idUser) references user(id), foreign key (idSystem) references system(id), primary key (id));

insert into system (id) values(1);
insert into system (id) values(2);
insert into system (id) values(3);

insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance, minimumScore) values (1,1,0,0,0,0,60);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance, minimumScore) values (1,2,0,0,0,0,60);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance, minimumScore) values (1,3,0,0,0,0,60);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance, minimumScore) values (2,3,0,0,0,0,50);
insert into operationMode (id, idSystem, falseRejection, falseAcceptance, trueRejection, trueAcceptance, minimumScore) values (3,3,0,0,0,0,70);
